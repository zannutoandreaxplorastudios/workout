...
const config = {
  chest: {
    label: "Pettorali", bg: "bg-rose-500/15", text: "text-rose-500",
  ...
  hamstrings: {
    label: "Femorali", bg: "bg-lime-500/15", text: "text-lime-500",
  ...
  shoulders: {
    label: "Deltoidi", bg: "bg-amber-500/15", text: "text-amber-500",
    svg: <Svg><path d="M4 18c0-8 3.5-14 8-14s8 6 8 14H4z" fill="currentColor" opacity="0.8"/></Svg>,
  },
  triceps: {
    label: "Tricipiti", bg: "bg-violet-500/15", text: "text-violet-500",
  ...
  biceps: {
    label: "Bicipiti", bg: "bg-teal-500/15", text: "text-teal-500",
  ...
  abs: {
    label: "Addominali", bg: "bg-orange-500/15", text: "text-orange-500",
